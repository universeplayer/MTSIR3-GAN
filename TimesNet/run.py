...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_id', type=str, default='PSM_mask_0.25', help='model id')
    parser.add_argument('--model', type=str, default='TimesNet',
                        help='model name, options: [Autoformer, Transformer, TimesNet]')

    # data loader
    parser.add_argument('--data', type=str, default='PSM', help='dataset type')
    parser.add_argument('--root_path', type=str, default='./datasets/PSM/', help='root path of the data file')
